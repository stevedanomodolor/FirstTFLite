...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Interact with the button and the text
    ...
    // helper function that loads the Tensorflow lite model from the assets directory
    ...
    private fun doInference(){
        ...
        //Input type is floatarray similar to a numpy array
